...
result1 = cv2.warpAffine(image, warpMat1, (image.shape[1], image.shape[0]), None, flags=cv2.INTER_LINEAR, borderMode=cv2.BORDER_REFLECT_101)
result2 = cv2.warpAffine(image, warpMat2, (image.shape[1], image.shape[0]), None, flags=cv2.INTER_LINEAR, borderMode=cv2.BORDER_REFLECT_101)
